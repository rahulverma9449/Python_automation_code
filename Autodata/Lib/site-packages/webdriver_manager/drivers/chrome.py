import packaging
import webdriver_manager.core.driver
from webdriver_manager.core.logger import log
from webdriver_manager.core.utils import ChromeType, is_arch, is_mac_os


class ChromeDriver(webdriver_manager.core.driver.Driver):
    ...
    def get_url(self):
        ...
        if version.parse(browser_version) < version.parse("110.0.5481.104") :
