...
def retry_with_counter_until_status_is_success(max_retry=10, sleep_time=3):
    ...
    while counter < max_retry:
        ...
        print("the Succes status is: {}".format(is_success))
    ...
    if not is_success:
        raise Exception("The process did not succes after trying for {} seconds.".format(max_retry * sleep_time))
...
retry_with_counter_until_status_is_success(max_retry=4, sleep_time=1)